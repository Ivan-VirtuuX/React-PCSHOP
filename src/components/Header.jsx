    ...
    <header className="d-flex justify-between align-center p-40">
      <Link to="/">
        <div className="d-flex align-center">
          ...
          >
            <path
              d="M32.5 5H7.5C6.11929 5 5 6.11929 5 7.5V25.8333C5 27.214 6.11929 28.3333 7.5 28.3333H32.5C33.8807 28.3333 35 27.214 35 25.8333V7.5C35 6.11929 33.8807 5 32.5 5Z"
              stroke="#0F98DA"
              stroke-width="4"
              stroke-linejoin="round"
            />
            <path
              d="M20 28.3333V35M11.6667 35H28.3333H11.6667Z"
              stroke="#0F98DA"
              stroke-width="4"
          ...
          <div className="ml-20">
            <h3 className="text-uppercase" style={{ color: "#0F98DA" }}>
              PCSHOP
            </h3>
            <p className="opacity-5">Магазин лучших комплектующих</p>
          </div>
        </div>
      </Link>
      <ul className="d-flex navbar">
        <li onClick={onClickCart} className="mr-30 d-flex align-center cu-p">
          ...
          <span>
            <b style={{ color: "#5C5C5C" }}>{cartSum} руб.</b>
          </span>
        </li>
        <li className="mr-30">
          <Link to="/favorites">
